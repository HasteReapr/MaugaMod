        ...
        private void Fire()
        {
            if (!hasFired)
            {
                ...
                if (isAuthority)
                {
                    ...
                    float randomSpread = chaingunComp.firingGunny ? 3 : 1.5f;

                    FireProjectileInfo info = new FireProjectileInfo()
                    {
                        owner = gameObject,
                        damage = MaugaStaticValues.chaChaBombDmgCoeff * characterBody.damage,
                        force = 5,
                        ...
                        projectilePrefab = MaugaAssets.maugaBombProjPrefab,
                        speedOverride = 96,
                    };
